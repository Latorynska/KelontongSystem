                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg h-full">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div class="flex items-center justify-between p-2 text-lg font-bold">
                            <span>Update Staff Data</span>
                        </div>
                        <form method="post" action="{{ route('branchstaff.update', ['id' => $staff->user->id]) }}">
                            @csrf
                            @method('PATCH')
                            <!-- staff name -->
                                ...
                                <div class="relative">
                                    ...
                                    >
                                        ...
                                        @foreach ($roles as $role)  
                                            <option value="{{ $role->name }}" {{ old('role', $staff->user->roles->first()->name ?? '') == $role->name ? 'selected' : '' }}>
                                                {{ $role->name }}
                                            </option>
                                        @endforeach
                                    </select>
